...
1:                                                ; preds = %.lr.ph, %9
  %2 = phi i32 [ %.pre, %.lr.ph ], [ %10, %9 ], !dbg !30
  ...
  %3 = getelementptr inbounds i32, i32* %0, i64 %indvars.iv.next, !dbg !36
  %4 = load i32, i32* %3, align 4, !dbg !36
  %5 = getelementptr inbounds i32, i32* %0, i64 %indvars.iv, !dbg !30
  %6 = icmp slt i32 %4, %2, !dbg !37
  br i1 %6, label %7, label %9, !dbg !38

7:                                                ; preds = %1
  call void @llvm.dbg.value(metadata i32 %4, metadata !39, metadata !DIExpression()), !dbg !41
  %8 = load i32, i32* %5, align 4, !dbg !42
  store i32 %8, i32* %3, align 4, !dbg !43
  store i32 %4, i32* %5, align 4, !dbg !44
...
9:                                                ; preds = %1, %7
  ...
  br i1 %exitcond.not, label %._crit_edge, label %1, !dbg !34, !llvm.loop !47
...
.lr.ph:                                           ; preds = %3, %18
  ...
  br i1 %7, label %8, label %18, !dbg !87

8:                                                ; preds = %.lr.ph
  %9 = add i32 %.04, 1, !dbg !88
  %10 = zext i32 %9 to i64, !dbg !90
  %11 = getelementptr inbounds i32, i32* %0, i64 %10, !dbg !90
  %12 = bitcast i32* %11 to i8*, !dbg !91
  %13 = bitcast i32* %5 to i8*, !dbg !91
  %14 = sub i32 %1, %.04, !dbg !92
  %15 = zext i32 %14 to i64, !dbg !93
  %16 = shl nuw nsw i64 %15, 2, !dbg !94
  %17 = call i8* @memmove(i8* %12, i8* %13, i64 %16), !dbg !91
  br label %.loopexit, !dbg !95

18:                                               ; preds = %.lr.ph
  %19 = add i32 %.04, 1, !dbg !96
  call void @llvm.dbg.value(metadata i32 %19, metadata !78, metadata !DIExpression()), !dbg !75
  %.not = icmp eq i32 %19, %1, !dbg !79
...
.loopexit:                                        ; preds = %3, %..loopexit_crit_edge, %8
  %.pre-phi = phi i64 [ %4, %8 ], [ %phi.cast, %..loopexit_crit_edge ], [ 0, %3 ], !dbg !99
  %20 = getelementptr inbounds i32, i32* %0, i64 %.pre-phi, !dbg !99
  store i32 %2, i32* %20, align 4, !dbg !100
  ret void, !dbg !101
}
...
33:                                               ; preds = %.lr.ph
  call void @llvm.dbg.value(metadata i32 %37, metadata !129, metadata !DIExpression()), !dbg !131
  %.not = icmp eq i32 %37, 4, !dbg !132
  br i1 %.not, label %._crit_edge, label %._crit_edge3, !dbg !134, !llvm.loop !135

._crit_edge3:                                     ; preds = %33
  %.phi.trans.insert = zext i32 %37 to i64
...
.lr.ph:                                           ; preds = %1, %._crit_edge3
  %34 = phi i32 [ %.pre6, %._crit_edge3 ], [ %25, %1 ], !dbg !137
  %35 = phi i32 [ %.pre, %._crit_edge3 ], [ %17, %1 ], !dbg !137
  %.02 = phi i32 [ %37, %._crit_edge3 ], [ 0, %1 ]
  call void @llvm.dbg.value(metadata i32 %.02, metadata !129, metadata !DIExpression()), !dbg !131
  %36 = icmp eq i32 %35, %34, !dbg !137
  %37 = add i32 %.02, 1, !dbg !140
  call void @llvm.dbg.value(metadata i32 %37, metadata !129, metadata !DIExpression()), !dbg !131
  br i1 %36, label %33, label %38, !dbg !141
...
define dso_local i8* @memmove(i8* returned %0, i8* readonly %1, i64 %2) local_unnamed_addr #0 !dbg !186 {
  ...
  br i1 %4, label %.loopexit, label %5, !dbg !196

5:                                                ; preds = %3
  %6 = icmp ugt i8* %1, %0, !dbg !197
  br i1 %6, label %.preheader, label %11, !dbg !199
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %.0111 = phi i8* [ %8, %.lr.ph ], [ %1, %.preheader ]
  %.0210 = phi i8* [ %10, %.lr.ph ], [ %0, %.preheader ]
  %.049 = phi i64 [ %7, %.lr.ph ], [ %2, %.preheader ]
  ...
  %7 = add i64 %.049, -1, !dbg !202
  call void @llvm.dbg.value(metadata i64 %7, metadata !191, metadata !DIExpression()), !dbg !189
  %8 = getelementptr inbounds i8, i8* %.0111, i64 1, !dbg !203
  call void @llvm.dbg.value(metadata i8* %8, metadata !193, metadata !DIExpression()), !dbg !189
  %9 = load i8, i8* %.0111, align 1, !dbg !204
  %10 = getelementptr inbounds i8, i8* %.0210, i64 1, !dbg !205
  call void @llvm.dbg.value(metadata i8* %10, metadata !192, metadata !DIExpression()), !dbg !189
  store i8 %9, i8* %.0210, align 1, !dbg !206
  call void @llvm.dbg.value(metadata i64 %7, metadata !191, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !189
  %.not6 = icmp eq i64 %7, 0, !dbg !200
...
.lr.ph16:                                         ; preds = %11
  %12 = add i64 %2, -1, !dbg !210
  call void @llvm.dbg.value(metadata !DIArgList(i8* %1, i64 %12), metadata !193, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 1, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)), !dbg !189
  %13 = getelementptr inbounds i8, i8* %1, i64 %12, !dbg !211
  call void @llvm.dbg.value(metadata i8* %13, metadata !193, metadata !DIExpression()), !dbg !189
  call void @llvm.dbg.value(metadata !DIArgList(i8* %0, i64 %12), metadata !192, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 1, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)), !dbg !189
  %14 = getelementptr inbounds i8, i8* %0, i64 %12, !dbg !212
  call void @llvm.dbg.value(metadata i8* %14, metadata !192, metadata !DIExpression()), !dbg !189
  br label %15, !dbg !208

15:                                               ; preds = %.lr.ph16, %15
  %.115 = phi i8* [ %13, %.lr.ph16 ], [ %17, %15 ]
  %.1314 = phi i8* [ %14, %.lr.ph16 ], [ %19, %15 ]
  %.1513 = phi i64 [ %2, %.lr.ph16 ], [ %16, %15 ]
  ...
  %16 = add i64 %.1513, -1, !dbg !213
  call void @llvm.dbg.value(metadata i64 %16, metadata !191, metadata !DIExpression()), !dbg !189
  %17 = getelementptr inbounds i8, i8* %.115, i64 -1, !dbg !214
  call void @llvm.dbg.value(metadata i8* %17, metadata !193, metadata !DIExpression()), !dbg !189
  %18 = load i8, i8* %.115, align 1, !dbg !215
  %19 = getelementptr inbounds i8, i8* %.1314, i64 -1, !dbg !216
  call void @llvm.dbg.value(metadata i8* %19, metadata !192, metadata !DIExpression()), !dbg !189
  store i8 %18, i8* %.1314, align 1, !dbg !217
  call void @llvm.dbg.value(metadata i64 %16, metadata !191, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)), !dbg !189
  %.not = icmp eq i64 %16, 0, !dbg !208
  br i1 %.not, label %.loopexit, label %15, !dbg !208, !llvm.loop !218

.loopexit:                                        ; preds = %15, %.lr.ph, %11, %.preheader, %3
  ret i8* %0, !dbg !219
}
