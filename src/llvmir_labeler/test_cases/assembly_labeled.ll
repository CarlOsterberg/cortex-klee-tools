...
define dso_local i32 @get_sign(i32 %0) #0 !dbg !9 {
  ...
  br i1 %5, label %.customlabel0, label %.customlabel1, !dbg !18

.customlabel0:                                               ; preds = %1
  store i32 0, i32* %2, align 4, !dbg !19
  br label %.customlabel4, !dbg !19

.customlabel1:                                               ; preds = %1
  %6 = load i32, i32* %3, align 4, !dbg !20
  %7 = icmp slt i32 %6, 0, !dbg !22
  br i1 %7, label %.customlabel2, label %.customlabel3, !dbg !23

.customlabel2:                                              ; preds = %.customlabel1
  store i32 -1, i32* %2, align 4, !dbg !24
  br label %.customlabel4, !dbg !24

.customlabel3:                                              ; preds = %.customlabel1
  store i32 1, i32* %2, align 4, !dbg !25
  br label %.customlabel4, !dbg !25

.customlabel4:                                              ; preds = %.customlabel3, %.customlabel2, %.customlabel0
